...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_absolem(
    ...
    KC_NO, KC_NO, MT(KC_LCTL, KC_TAB), LT(NAV, KC_SPC),  MT(MOD_MEH, KC_ENTER),  KC_LSHIFT,  LT(NUM, KC_BSPACE),  MT(KC_LGUI, KC_ESCAPE), KC_NO, KC_NO
),
   [_QWERTY] = LAYOUT_absolem(
    ...
    KC_NO, KC_NO, MT(KC_LCTL, KC_TAB), MT(NAV, KC_SPC),  MT(MOD_MEH, KC_ENTER),  KC_LSHIFT,  MT(NUM, KC_BSPACE),  MT(KC_LGUI, KC_ESCAPE), KC_NO, KC_NO
),
   ...
   [_NAV] = LAYOUT_absolem(
    ...
    KC_RGUI,    KC_RALT,    KC_RSFT,    KC_RCTRL,   KC_VOLD,    KC_PGDOWN, KC_NO,   KC_UP,   KC_NO,    KC_TAB,   
    LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_D), LCTL(KC_V), KC_APP,    KC_LEFT,  KC_DOWN, KC_RIGHT, KC_ENTER,
    KC_NO,      KC_NO,      KC_NO,      KC_X,     KC_NO,      KC_DEL,    KC_BSPACE, KC_ESCAPE, KC_NO, KC_NO
),
  [_NUM] = LAYOUT_absolem(
