...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_absolem(
   ...
   [_NAV] = LAYOUT_absolem(
       ...
       KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_PGDOWN,   KC_LEFT,   KC_DOWN,   KC_RIGHT, LGUI(KC_GRAVE),
       OSM(MOD_LGUI|MOD_LSFT), OSM(MOD_LSFT|MOD_LALT), OSM(MOD_LALT|MOD_LCTL), KC_LCTL,   KC_LALT, KC_APP,  KC_HOME,  KC_SPC, KC_END, LCA(KC_GRAVE),
  ...
  [_NUM] = LAYOUT_absolem(
      ...
      KC_F6,  KC_F7,  KC_F8,  KC_F9,   KC_F10,     KC_PPLS,  KC_P4,     KC_P5, KC_6,  KC_PDOT,
      KC_F11, KC_F12, KC_F13, KC_PSCR, KC_PAUS,    KC_P0,    KC_P1,     KC_P2, KC_P3, KC_PCMM,
